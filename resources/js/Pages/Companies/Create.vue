            ...
            <div class="mb-7 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                <div>
                    ...
                    <p class="mt-2 max-w-3xl text-sm leading-6 text-slate-500">
                        Registra los datos generales, fiscales y comisiones base de la empresa.
                    </p>
                </div>
                ...
                <section class="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm">
                    ...
                    <div class="grid gap-5 p-6 md:grid-cols-2">
                        <div class="md:col-span-2">
                            ...
                            <input v-model="form.name" type="text" :class="inputClass" placeholder="Nombre comercial o razón social" />
                        ...
                        <div>
                            ...
                            <input v-model="form.code" type="text" :class="inputClass" placeholder="Ej. SICEM" />
                        ...
                        <div>
                            ...
                            <input v-model="form.rfc" type="text" :class="inputClass" placeholder="RFC" />
                        ...
                        <div>
                            ...
                            <input v-model="form.phone" type="text" :class="inputClass" placeholder="Teléfono de contacto" />
                        ...
                        <div>
                            ...
                            <input v-model="form.email" type="email" :class="inputClass" placeholder="correo@empresa.com" />
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea v-model="form.address" rows="4" :class="textareaClass" placeholder="Dirección fiscal o principal" />
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input v-model="form.website" type="text" :class="inputClass" placeholder="https://..." />

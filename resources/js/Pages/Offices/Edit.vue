...
const form = useForm({
    ...
    serie: props.office.serie || '',
    phone: props.office.phone || '',
    address: props.office.address || '',
    schedule: props.office.schedule || '',
    bank_account: props.office.bank_account || '',
    daily_interest_rate: props.office.daily_interest_rate ?? 0,
    monthly_interest_rate: props.office.monthly_interest_rate ?? 0,
    cash: props.office.cash ?? 0,
})
                ...
                <div class="flex gap-3">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm">
                            No puedes editar una sucursal archivada. Primero restáurala.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <section class="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm">
                    <div class="border-b border-slate-100 px-6 py-5">
                        ...
                        <p class="text-sm text-slate-500">
                            Actualiza datos operativos y datos para tickets.
                        </p>
                    </div>
                    ...
                    <div class="grid gap-5 p-6 md:grid-cols-2">
                        <div class="md:col-span-2">
                            ...
                            <select v-model="form.company_id" :class="selectClass" :disabled="office.is_deleted">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input v-model="form.name" type="text" :class="inputClass" :disabled="office.is_deleted" />
                        ...
                        <div>
                            ...
                            <input v-model="form.code" type="text" :class="inputClass" :disabled="office.is_deleted" />
                        ...
                        <div>
                            ...
                            <input v-model="form.serie" type="text" :class="inputClass" :disabled="office.is_deleted" />
                        ...
                        <div>
                            ...
                            <input v-model="form.phone" type="text" :class="inputClass" :disabled="office.is_deleted" />
                        ...
                        <div>
                            ...
                            <input v-model="form.bank_account" type="text" :class="inputClass" :disabled="office.is_deleted" />
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea v-model="form.address" rows="4" :class="textareaClass" :disabled="office.is_deleted" />
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea v-model="form.schedule" rows="3" :class="textareaClass" :disabled="office.is_deleted" />
                ...
                <aside class="space-y-6">
                    ...
                    <section class="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
                        ...
                        <div class="mt-5">
                            ...
                            <input v-model="form.cash" type="number" step="0.01" :class="inputClass" :disabled="office.is_deleted" />
                    ...
                    <section class="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
                        ...
                        <div class="mt-5 space-y-4">
                            <div>
                                ...
                                <input v-model="form.daily_interest_rate" type="number" min="0" step="0.0001" :class="inputClass" :disabled="office.is_deleted" />
                            ...
                            <div>
                                ...
                                <input v-model="form.monthly_interest_rate" type="number" min="0" step="0.0001" :class="inputClass" :disabled="office.is_deleted" />
                    ...
                    <button
                        ...
                        :disabled="form.processing || office.is_deleted"
                    >
                        <svg class="h-4 w-4" viewBox="0 0 24 24" fill="none">

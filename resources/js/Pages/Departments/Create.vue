        ...
        <div class="px-4 py-6 sm:px-6 lg:px-8">
            <div class="mb-7">
                ...
                <p class="mt-2 max-w-3xl text-sm leading-6 text-slate-500">
                    Configura las reglas financieras que heredarán los productos y operaciones de empeño.
                </p>
            </div>
                    ...
                    <div class="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
                        <div class="mb-6 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-slate-500">
                                    Código, descripción y estado del departamento.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="grid gap-4 md:grid-cols-2">
                            <div>
                                ...
                                <input v-model="form.code" type="text" :class="inputClass" placeholder="ORO" />
                            ...
                            <div>
                                ...
                                <input v-model="form.description" type="text" :class="inputClass" placeholder="ORO Y PLATA" />
                    ...
                    <div class="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
                        <div class="mb-6 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-slate-500">
                                    Tiempo de vencimiento y días para remate.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
                        <div class="mb-6 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-slate-500">
                                    Porcentajes utilizados para calcular el préstamo y los intereses.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="grid gap-4 md:grid-cols-3">
                            <div>
                                ...
                                <input v-model="form.loan_rate" type="number" step="0.001" :class="inputClass" placeholder="85.000" />
                            ...
                            <div>
                                ...
                                <input v-model="form.daily_interest_rate" type="number" step="0.001" :class="inputClass" placeholder="0.400" />
                            ...
                            <div>
                                ...
                                <input v-model="form.monthly_interest_rate" type="number" step="0.001" :class="inputClass" placeholder="12.000" />
                            ...
                            <div>
                                ...
                                <input v-model="form.iva_rate" type="number" step="0.001" :class="inputClass" placeholder="16.000" />
                            ...
                            <div>
                                ...
                                <input v-model="form.cat_annual" type="number" step="0.001" :class="inputClass" placeholder="167.040" />
                            ...
                            <div>
                                ...
                                <input v-model="form.cat_annual_noiva" type="number" step="0.001" :class="inputClass" placeholder="144.000" />
                    ...
                    <div class="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
                        <div class="mb-6 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-slate-500">
                                    Color e ícono opcional para identificar el departamento.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="grid gap-4 md:grid-cols-2">
                            <div>
                                ...
                                <input v-model="form.color" type="text" :class="inputClass" placeholder="#5b55a4" />
                            ...
                            <div>
                                ...
                                <input v-model="form.icon" type="text" :class="inputClass" placeholder="fa fa-diamond" />

...
const statusBadgeClass = (expense) => {
    return expense.is_cancelled
    ...
    <AdminLayout>
        <div class="px-4 py-6 sm:px-6 lg:px-8">
            <div class="mb-7 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                <div>
                    ...
                    <p class="mt-2 text-sm text-slate-500">
                        Registra y consulta salidas manuales de dinero en
            ...
            <div class="mb-6 grid gap-5 md:grid-cols-3">
                <div class="rounded-[1.75rem] border border-red-100 bg-white p-5 shadow-sm">
                    ...
                    <p class="mt-1 text-sm font-semibold text-slate-500">
                        {{ summary.count_active || 0 }} gastos activos
                    </p>
                </div>
                    ...
                    <div class="mb-5 flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-slate-500">
                                Busca gastos por ID, usuario, monto o motivo.
                            </p>
                        </div>
                    </div>
            ...
            <section class="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm">
                ...
                <div v-if="expenses.data?.length" class="overflow-x-auto">
                            ...
                            >
                                <td class="px-5 py-4">
                                    <div class="flex items-center gap-3">
                                        <div class="flex h-11 w-11 items-center justify-center rounded-2xl bg-red-500 text-white">
                                            <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none">
                                                <path
                                                    :d="iconPath('expense')"
                                                    stroke="currentColor"
                                ...
                                <td class="px-5 py-4">
                                    <p class="line-clamp-2 max-w-md text-sm font-medium text-slate-600">
                                        {{ expense.comments || 'Sin motivo' }}
                                    </p>
                                    <p v-if="expense.user" class="mt-1 text-xs font-bold text-slate-400">
                                        Registró: {{ expense.user.name }}
                                    </p>
                                </td>
                                ...
                                <td class="px-5 py-4">
                                    <span
                                        ...
                                        :class="paymentBadgeClass(expense.payment_type)"
                                    >
                                ...
                                <td class="px-5 py-4 text-right">
                                    <p class="text-base font-black" :class="amountClass(expense)">
                                ...
                                <td class="px-5 py-4">
                                    <span
                                        class="inline-flex rounded-full border px-3 py-1 text-xs font-black"
                                        :class="statusBadgeClass(expense)"
                                    >
                                        {{ expense.is_cancelled ? 'Cancelado' : 'Activo' }}
                                    </span>
                                    <p v-if="expense.canceled_at" class="mt-1 text-xs text-slate-400">
                                        {{ expense.canceled_at }}
                                    </p>
                                </td>
                ...
                <div v-else class="p-10 text-center">
                    ...
                    <p class="mt-2 text-sm text-slate-500">
                        Cuando registres gastos manuales aparecerán en esta sección.
                    </p>
                </div>

                <div
                    v-if="expenses.links?.length"
                ...
                >
                    <p class="text-sm font-semibold text-slate-500">
                        Mostrando {{ expenses.from || 0 }} a {{ expenses.to || 0 }} de {{ expenses.total || 0 }}
                    </p>

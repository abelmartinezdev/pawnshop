        ...
        <div class="px-4 py-6 sm:px-6 lg:px-8">
            <div class="mb-7">
                ...
                <p class="mt-2 text-sm text-slate-500">
                    Registra una entrada manual de dinero para la sucursal activa.
                </p>
            </div>
                    ...
                    <div class="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm">
                        ...
                        <div class="p-6">
                            ...
                            <p class="mt-4 text-sm leading-6 text-slate-500">
                                Si el ingreso es en efectivo, aumentará la caja física de la sucursal.
                    ...
                    <div class="mb-6 flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-slate-500">
                                Captura el monto y motivo del ingreso.
                            </p>
                        </div>
                    </div>
                    ...
                    <form class="space-y-5" @submit.prevent="submit">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="Ej. Ingreso por ajuste de caja, depósito recibido, entrada extraordinaria..."
                            />
                        ...
                        <div class="flex flex-col-reverse gap-3 pt-2 sm:flex-row sm:justify-end">
                            ...
                            <button
                                type="submit"
                                class="rounded-2xl bg-emerald-500 px-5 py-3 text-sm font-black text-white shadow-lg shadow-emerald-200 transition hover:-translate-y-0.5 hover:bg-emerald-600 disabled:cursor-not-allowed disabled:opacity-60"
                                :disabled="form.processing"
                            >
                                {{ form.processing ? 'Guardando...' : 'Registrar ingreso' }}
                            </button>
                        </div>
                    </form>
                </section>
